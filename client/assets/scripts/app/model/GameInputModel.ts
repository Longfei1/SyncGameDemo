import { input, Input, macro, EventKeyboard, KeyCode } from "cc";
...
class GameInputModel extends BaseModel {
     ...
     */
    addKeyDownOnceListener(keyDownCallBack: Function, keyUpCallBack: Function, context: any, key?: KeyCode) {
     ...
     */
    addKeyDownIntervalListener(keyDownCallBack: Function, keyUpCallBack: Function, context: any, key?: KeyCode, interval?: number) {
     ...
     * @param key 按键值,没有时所有按键都触发
     */
    addKeyDownListener(keyDownCallBack: Function, context: any, key?: KeyCode) {
     ...
     * @param key 按键值,没有时所有按键都触发
     */
    addKeyUpListener(keyUpCallBack: Function, context: any, key?: KeyCode) {
     ...
     * @param key 按键值
     */
    removeKeyDownOnceListener(context: any, key?: KeyCode) {
        key = key ? key : null;
     ...
     * @param key 按键值
     */
    removeKeyDownIntervalListener(context: any, key?: KeyCode) {
        key = key ? key : null;
     ...
     * @param key 按键值
     */
    removeKeyDownListener(context: any, key?: KeyCode) {
        key = key ? key : null;
     ...
     * @param key 按键值
     */
    removeKeyUpListener(context: any, key?: KeyCode) {
        key = key ? key : null;
     ...
     * @param context 监听上下文
     */
    private removeInputListener(key: KeyCode, inputMode: InputMode, context: any) {
     ...
     */
    private addInputListener(inputMode: InputMode, keyDownCallBack: Function, keyUpCallBack: Function, context: any, key?: KeyCode, interval?: number) {
...
class Observer {
    ...
    constructor(keyDownCallBack: Function, keyUpCallBack: Function, context: any, inputMode: InputMode, key?: KeyCode, interval?: number) {
